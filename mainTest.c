...
{
    const char *test_cases[] = {
        " Hola mundo ",         // Caso 1: Espacios al principio y al final
        "   Testing   ",        // Caso 2: Espacios al principio y al final
        "Dynamic Mem",          // Caso 3: Sin espacios para recortar
        "  ",                   // Caso 4: Solo espacios
        "",                     // Caso 5: Cadena vacía
        NULL                    // Terminador del array
    };

    const char *test_sets[] = {
        " ",    // Set de caracteres a recortar: espacio
        "",     // Set vacío (ningún carácter se recorta)
        "ac",   // Set de caracteres a recortar: 'a' y 'c'
        "def",  // Set de caracteres a recortar: 'd', 'e', 'f'
        NULL    // Terminador del array
    };
    ...
    while (test_cases[i])
    {
        ...
        while (test_sets[j])
        {
            char *result = ft_strtrim(test_cases[i], test_sets[j]);

            printf("----------------------------------------------------------\n");
            printf("Test Case %lu:\n", i * (sizeof(test_sets) / sizeof(*test_sets)) + j + 1);
            printf("----------------------------------------------------------\n");
            printf("Original: '%s'\n", test_cases[i]);
            printf("Set: '%s'\n", test_sets[j]);
            ...
            {
                printf("Result: '%s'\n", result);
                free(result); // Liberar memoria asignada por ft_strtrim
            }
            else
            {
...
int     main(void)
{
        const char      s[]="Hola mundo Hello world";
        char            c = ' ';
        char    **result;
        size_t          i;
...
{
    char *test_cases[] = {
        "Hola mundo Hello world",     // Caso 1: Frase con espacios
        "Separar,por,comas",          // Caso 2: Frase con comas
        "   Espacios   al   inicio",  // Caso 3: Espacios al inicio
        "Espacios al final   ",       // Caso 4: Espacios al final
        "   Espacios  en  ambos  lados   ", // Caso 5: Espacios en ambos lados
        "Unapalabragrande",           // Caso 6: Sin delimitadores
        "",                           // Caso 7: Cadena vacía
        NULL                          // Terminador del array
    };

    char delimiters[] = {
        ' ',   // Delimitador para casos 1, 3, 4, 5
        ',',   // Delimitador para caso 2
        ' ',   // Delimitador para caso 6
        ' ',   // Delimitador para caso 7
        '\0'   // Terminador del array
    };
